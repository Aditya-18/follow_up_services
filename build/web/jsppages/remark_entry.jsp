...
<html>
    ...
    int i=s.executeUpdate("insert into remark (Eid,Customer_firstName,Customer_middleName,Customer_lastName,Mobile,Status,Comment) values('"+eid+"','"+fname+"','"+mname+"','"+lname+"','"+mobile+"','"+status+"','"+comment+"')");
     if(i>0)
     {
