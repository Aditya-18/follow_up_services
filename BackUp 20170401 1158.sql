...
CREATE DATABASE IF NOT EXISTS advance;
USE advance;
...
CREATE TABLE `dept` (
  ...
  `Dept_Add` varchar(20) default NULL,
  PRIMARY KEY  (`Dept_no`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `faculty` (
  ...
  `Fac_Name` char(20) NOT NULL,
  `Dept_no` int(2) default NULL,
  `address` varchar(20) default NULL,
  `contact` bigint(20) default NULL,
  PRIMARY KEY  (`Fac_id`),
  KEY `Dept_no` (`Dept_no`),
  CONSTRAINT `faculty_ibfk_1` FOREIGN KEY (`Dept_no`) REFERENCES `dept` (`Dept_no`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `student` (
  ...
  `D_no` int(2) default NULL,
  `contact` bigint(20) default NULL,
  `address` varchar(20) default NULL,
  PRIMARY KEY  (`Roll_no`),
  KEY `D_no` (`D_no`),
  CONSTRAINT `student_ibfk_1` FOREIGN KEY (`D_no`) REFERENCES `dept` (`Dept_no`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `dependent` (
  ...
  `Dependent_Name` char(30) NOT NULL default '',
  `Gender` char(2) default NULL,
  `Relationship` varchar(50) default NULL,
  PRIMARY KEY  (`EMP_ID`,`Dependent_Name`),
  CONSTRAINT `dependent_ibfk_1` FOREIGN KEY (`EMP_ID`) REFERENCES `emp` (`EMP_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `dependent` (`EMP_ID`,`Dependent_Name`,`Gender`,`Relationship`) VALUES 
 (123456789,'Alice','F','Daughter'),
 (123456789,'Elizabeth','F','Spouse'),
 (123456789,'Michael','M','Son'),
 (333445555,'Alice','F','Daughter'),
 (333445555,'Joy','F','Spouse'),
 (333445555,'Theodore','M','Son'),
 (987654321,'Abner','M','Spouse');
...
DROP TABLE IF EXISTS `dept`;
CREATE TABLE `dept` (
  `D_No` int(5) NOT NULL default '0',
  `Dname` char(30) default NULL,
  `Mgr_ID` int(10) default NULL,
  `Mgr_st_date` date default NULL,
  PRIMARY KEY  (`D_No`),
  KEY `Mgr_ID` (`Mgr_ID`),
  CONSTRAINT `dept_ibfk_1` FOREIGN KEY (`Mgr_ID`) REFERENCES `emp` (`EMP_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
/*!40000 ALTER TABLE `dept` DISABLE KEYS */;
INSERT INTO `dept` (`D_No`,`Dname`,`Mgr_ID`,`Mgr_st_date`) VALUES 
 (1,'Headquaters',888665555,'1981-06-19'),
 (4,'Admistration',987654321,'1995-01-01'),
 (5,'Research',333445555,'1981-06-19');
/*!40000 ALTER TABLE `dept` ENABLE KEYS */;


--
-- Definition of table `dept_location`
--

DROP TABLE IF EXISTS `dept_location`;
CREATE TABLE `dept_location` (
  `D_No` int(5) NOT NULL default '0',
  `D_Loc` varchar(30) NOT NULL default '',
  PRIMARY KEY  (`D_No`,`D_Loc`),
  CONSTRAINT `dept_location_ibfk_1` FOREIGN KEY (`D_No`) REFERENCES `dept` (`D_No`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `dept_location` (`D_No`,`D_Loc`) VALUES 
 (1,'Houston'),
 (4,'Stafford'),
 (5,''),
 (5,'Bellaire'),
...
CREATE TABLE `emp` (
  ...
  KEY `D_No` (`D_No`),
  CONSTRAINT `emp_ibfk_2` FOREIGN KEY (`Super_ssn`) REFERENCES `emp` (`EMP_ID`),
  CONSTRAINT `emp_ibfk_3` FOREIGN KEY (`D_No`) REFERENCES `dept` (`D_No`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `emp` (`Fname`,`Lname`,`EMP_ID`,`Address`,`Gender`,`Salary`,`Super_ssn`,`D_No`) VALUES 
 ('John','Smith',123456789,'731 Fondren, Houston, TX','M',30000,333445555,5),
 ...
 ('Ahmad','Jabbar',987987987,'990 Dallas, Houston, TX','M',25000,987654321,4),
 ('Alicia','Zelaya',999887777,'3321 Castle, Spring, TX','F',25000,987654321,4);
/*!40000 ALTER TABLE `emp` ENABLE KEYS */;


--
-- Definition of table `m1`
--
...
INSERT INTO `m1` (`Fname`,`Lname`,`EMP_ID`,`Address`,`Gender`,`Salary`,`Super_ssn`,`D_No`) VALUES 
 ('John','Smith',123456789,'731 Fondren, Houston, TX','M',30000,333445555,5),
 ('Franklin','Wong',333445555,'638 Voss, Houston, TX','M',40000,888665555,5),
 ('Joyce','English',453453453,'5631 Rice, Houston, TX','F',25000,333445555,5),
 ('Ramesh','Narayan',666884444,'975 Fire Oak, Humble, TX','M',38000,333445555,5),
...
INSERT INTO `m3` (`Fname`,`Lname`,`EMP_ID`,`Address`,`Gender`,`Salary`,`Super_ssn`,`D_No`) VALUES 
 ('John','Smith',123456789,'731 Fondren, Houston, TX','M',30000,333445555,5),
 ('Franklin','Wong',333445555,'638 Voss, Houston, TX','M',40000,888665555,5),
 ('Joyce','English',453453453,'5631 Rice, Houston, TX','F',25000,333445555,5),
 ('Ramesh','Narayan',666884444,'975 Fire Oak, Humble, TX','M',38000,333445555,5),
...
INSERT INTO `m4` (`Fname`,`Salary`) VALUES 
 ('John',30000),
 ('Franklin',40000),
 ('Ramesh',38000),
 ('James',55000),
...
CREATE TABLE `project` (
  ...
  `P_No` int(5) NOT NULL default '0',
  `P_Loc` varchar(30) default NULL,
  `D_No` int(5) default NULL,
  PRIMARY KEY  (`P_No`),
  KEY `D_No` (`D_No`),
  CONSTRAINT `project_ibfk_1` FOREIGN KEY (`D_No`) REFERENCES `dept` (`D_No`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `project` (`P_Name`,`P_No`,`P_Loc`,`D_No`) VALUES 
...
CREATE TABLE `works_on` (
  ...
  KEY `P_No` (`P_No`),
  CONSTRAINT `works_on_ibfk_1` FOREIGN KEY (`P_No`) REFERENCES `project` (`P_No`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `works_on` (`EMP_ID`,`P_No`,`No_of_Hours`) VALUES 
 (123456789,1,32.5),
 (123456789,2,7.5),
 (333445555,2,10),
 (333445555,3,10),
...
INSERT INTO `employee` (`EmployeeID`,`Name`,`Mobile`,`Address`,`Password`) VALUES 
 (1,'Jai Prakash	',7209999999,'Palwal','123'),
 (2,'Aditya',946681997,'sdkjbsdkjb','1234');
...
CREATE TABLE `student_2` (
  ...
  PRIMARY KEY  (`Roll_No`),
  KEY `Dept_No` (`Dept_No`),
  CONSTRAINT `student_2_ibfk_1` FOREIGN KEY (`Dept_No`) REFERENCES `department` (`Dept_No`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `student_2` (`Roll_No`,`Name`,`Dept_No`) VALUES 
 (11,'adi',NULL),
 (101,'adi',NULL),
 (111,'abc',1),
 (121,'cde',1),
...
CREATE TABLE `emp` (
  ...
  PRIMARY KEY  (`UID`),
  KEY `D_No` (`D_No`),
  CONSTRAINT `emp_ibfk_1` FOREIGN KEY (`D_No`) REFERENCES `dept` (`D_No`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
/*!40000 ALTER TABLE `emp` DISABLE KEYS */;
INSERT INTO `emp` (`UID`,`Salary`,`D_No`,`E_Name`) VALUES 
 (1,10000,1,NULL),
 (2,20000,1,NULL),
 (3,15000,2,NULL),
 (4,5000,1,NULL),
...
--
-- Create schema hcl_core
--

CREATE DATABASE IF NOT EXISTS hcl_core;
USE hcl_core;
...
--
-- Definition of table `days_available`
--
...
CREATE TABLE `days_available` (
  ...
  PRIMARY KEY  USING BTREE (`Train_Id`,`Available_Days`),
...
CREATE TABLE `passenger` (
  ...
  `Train_ID` int(10) unsigned NOT NULL,
  PRIMARY KEY  USING BTREE (`PNR`,`Seat_Number`),
  KEY `Train_ID` (`Train_ID`),
  CONSTRAINT `passenger_ibfk_1` FOREIGN KEY (`Train_ID`) REFERENCES `train` (`Train_ID`),
  CONSTRAINT `passenger_ibfk_2` FOREIGN KEY (`Train_ID`) REFERENCES `train` (`Train_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Definition of table `passenger_ticket`
--
...
CREATE TABLE `passenger_ticket` (
  ...
  PRIMARY KEY  (`PNR`),
  KEY `Train_Id` (`Train_Id`),
  CONSTRAINT `passenger_ticket_ibfk_1` FOREIGN KEY (`Train_Id`) REFERENCES `train` (`Train_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `reservation` (
  ...
  `Resevation_Date` varchar(45) NOT NULL,
  `Resevation_Status` varchar(45) NOT NULL,
...
CREATE TABLE `route` (
  `Stop_Number` int(10) unsigned NOT NULL auto_increment,
  `Arrival_TIme` timestamp NOT NULL default '0000-00-00 00:00:00',
  `Departure_TIme` timestamp NOT NULL default '0000-00-00 00:00:00',
  `Train_Id` int(10) unsigned NOT NULL,
  `Source_Distane` int(10) unsigned NOT NULL,
  PRIMARY KEY  USING BTREE (`Stop_Number`),
  KEY `Train_Id` (`Train_Id`),
...
--
-- Definition of table `route_has_station`
--

DROP TABLE IF EXISTS `route_has_station`;
CREATE TABLE `route_has_station` (
  ...
  CONSTRAINT `route_has_station_ibfk_1` FOREIGN KEY (`Station_Id`) REFERENCES `station` (`Station_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
/*!40000 ALTER TABLE `route_has_station` DISABLE KEYS */;
/*!40000 ALTER TABLE `route_has_station` ENABLE KEYS */;
...
CREATE TABLE `train` (
  ...
  `Source_stn` int(10) unsigned NOT NULL,
  `Destination_stn` int(10) unsigned NOT NULL,
...
--
-- Definition of table `train_class`
--

DROP TABLE IF EXISTS `train_class`;
CREATE TABLE `train_class` (
  `Train_Type` int(10) unsigned NOT NULL auto_increment,
  `Sleeper` int(10) unsigned NOT NULL,
  `AC` int(10) unsigned NOT NULL,
  `Chair_Car` int(10) unsigned NOT NULL,
  `Train_Id` int(10) unsigned NOT NULL,
  PRIMARY KEY  (`Train_Type`),
  KEY `FK_train_class_1` (`Train_Id`),
  CONSTRAINT `FK_train_class_1` FOREIGN KEY (`Train_Id`) REFERENCES `train` (`Train_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Definition of table `train_status`
--

DROP TABLE IF EXISTS `train_status`;
CREATE TABLE `train_status` (
  `Available_Dates` int(10) unsigned NOT NULL,
  `Booked_SL` int(10) unsigned NOT NULL,
  `Booked_AC` int(10) unsigned NOT NULL,
  `Booked_CC` int(10) unsigned NOT NULL,
  `Waiting_SL` int(10) unsigned NOT NULL,
  `Waiting_AC` int(10) unsigned NOT NULL,
  `Waiting_CC` int(10) unsigned NOT NULL,
  `Available_SL` int(10) unsigned NOT NULL,
  `Available_AC` int(10) unsigned NOT NULL,
  `Available_CC` int(10) unsigned NOT NULL,
  `Train_Id` int(10) unsigned NOT NULL,
  PRIMARY KEY  (`Available_Dates`),
  KEY `Train_Id` (`Train_Id`),
  CONSTRAINT `train_status_ibfk_1` FOREIGN KEY (`Train_Id`) REFERENCES `train` (`Train_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Create schema practise1
--

CREATE DATABASE IF NOT EXISTS practise1;
USE practise1;
...
DROP TABLE IF EXISTS `dept`;
CREATE TABLE `dept` (
  `Dept_No` int(3) NOT NULL default '0',
...
/*!40000 ALTER TABLE `student` DISABLE KEYS */;
INSERT INTO `student` (`Roll_No`,`Name`,`D_No`) VALUES 
 (111,'abc',1),
 (121,'cde',1),
 (123,'def',2),
 (124,'fgh',3),
...
--
-- Create schema practise2
--

CREATE DATABASE IF NOT EXISTS practise2;
USE practise2;
...
CREATE TABLE `dependent` (
  ...
  `DependentName` char(50) NOT NULL default '',
  PRIMARY KEY  (`DependentName`,`EID`),
  KEY `EID` (`EID`),
  CONSTRAINT `dependent_ibfk_1` FOREIGN KEY (`EID`) REFERENCES `emp` (`EMP_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
/*!40000 ALTER TABLE `dependent` DISABLE KEYS */;
INSERT INTO `dependent` (`Gender`,`Relationship`,`EID`,`DependentName`) VALUES 
 ('M','Trainee',101,'Ankush'),
 ('M','Administrator',101,'Ashu'),
 ('M','Manager',104,'Mukesh'),
 ('M','Colleage',106,'Prateek'),
 ('F','Teacher',105,'Rahul'),
 ('M','Administrator',103,'Sahil'),
 ('F','Teacher',109,'Swati');
/*!40000 ALTER TABLE `dependent` ENABLE KEYS */;
...
CREATE TABLE `dept` (
  ...
  `Mgr_Date` date default NULL,
  `MgrID` int(10) default NULL,
  PRIMARY KEY  (`DNo`),
  KEY `MgrID` (`MgrID`),
  CONSTRAINT `dept_ibfk_1` FOREIGN KEY (`MgrID`) REFERENCES `emp` (`EMP_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
/*!40000 ALTER TABLE `dept` DISABLE KEYS */;
INSERT INTO `dept` (`DNo`,`DName`,`Mgr_Date`,`MgrID`) VALUES 
 (1,'CO','2007-06-06',101),
 (2,'CE','2007-09-15',103),
 (3,'ECE','2011-09-15',102),
 (4,'ME','2011-12-15',104),
 (5,'IT','2013-05-03',108);
/*!40000 ALTER TABLE `dept` ENABLE KEYS */;
...
--
-- Definition of table `deptloc`
--

DROP TABLE IF EXISTS `deptloc`;
CREATE TABLE `deptloc` (
  `DLoc` varchar(40) NOT NULL default '',
  `DNum` int(10) NOT NULL default '0',
  PRIMARY KEY  (`DNum`,`DLoc`),
  CONSTRAINT `deptloc_ibfk_1` FOREIGN KEY (`DNum`) REFERENCES `dept` (`DNo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `deptloc` (`DLoc`,`DNum`) VALUES 
 ('2, South Block, NIT Kurukshetra',1),
 ('2, South Block, NIT Kurukshetra',2),
 ('3, Opp. OAT, NIT Kurukshetra',3),
 ('4, Gandhi Road, NIT Kurukshetra',4),
 ('5, SENATE, NIT Kurukshetra',5);
...
CREATE TABLE `emp` (
  ...
  KEY `DNum` (`DNum`),
  KEY `SuperID` (`SuperID`),
  CONSTRAINT `emp_ibfk_1` FOREIGN KEY (`DNum`) REFERENCES `dept` (`DNo`),
  CONSTRAINT `emp_ibfk_2` FOREIGN KEY (`SuperID`) REFERENCES `emp` (`EMP_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
/*!40000 ALTER TABLE `emp` DISABLE KEYS */;
INSERT INTO `emp` (`Fname`,`LName`,`EMP_ID`,`Address`,`Gender`,`Salary`,`DNum`,`SuperID`) VALUES 
 ('Aditya','Goel',101,'ADD1','M',10000000,1,102),
 ('Kunal','Bansal',102,'ADD2','M',11000000,2,104),
 ('Aman','Goyal',103,'ADD3','M',11000000,1,101),
 ('Vishal','Arora',104,'ADD4','M',5000000,5,108),
 ('Priyanka','Wadhwa',105,'ADD4','F',2000000,2,104),
 ('Chirag','Kapoor',106,'ADD5','M',2050000,3,109),
 ('Shubham','Mittal',108,'ADD6','M',350000,4,106),
 ('Anita','Kumble',109,'ADD7','F',450000,5,103);
/*!40000 ALTER TABLE `emp` ENABLE KEYS */;
...
CREATE TABLE `project` (
  ...
  PRIMARY KEY  (`PNo`),
  KEY `DNum` (`DNum`),
  CONSTRAINT `project_ibfk_1` FOREIGN KEY (`DNum`) REFERENCES `dept` (`DNo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
/*!40000 ALTER TABLE `project` DISABLE KEYS */;
INSERT INTO `project` (`PName`,`PNo`,`PLoc`,`DNum`) VALUES 
 ('Follow Up Services',1,'HCL, Delhi',1),
 ('Image Recognition',2,'NIT, Delhi',2),
 ('Optical Transmission',3,'NIT, Kurukshetra',3),
 ('Power Transmission',4,'HCL, Delhi',1),
 ('Remote Cam',5,'HCL, Delhi',5);
/*!40000 ALTER TABLE `project` ENABLE KEYS */;


--
-- Definition of table `workson`
--

DROP TABLE IF EXISTS `workson`;
CREATE TABLE `workson` (
  `No_Of_Hours` int(40) default NULL,
  `EID` int(10) NOT NULL default '0',
  `P_Num` int(10) NOT NULL default '0',
  PRIMARY KEY  (`EID`,`P_Num`),
  KEY `P_Num` (`P_Num`),
  CONSTRAINT `workson_ibfk_1` FOREIGN KEY (`P_Num`) REFERENCES `project` (`PNo`),
  CONSTRAINT `workson_ibfk_2` FOREIGN KEY (`EID`) REFERENCES `emp` (`EMP_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `workson` (`No_Of_Hours`,`EID`,`P_Num`) VALUES 
 (50,101,4),
 (60,102,1),
 (70,103,5),
 (87,104,1),
...
CREATE TABLE `customer` (
  ...
  PRIMARY KEY  (`Email`),
  KEY `Eid` (`Eid`),
  CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`Eid`) REFERENCES `register` (`Eid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `customer` (`FirstName`,`MiddleName`,`LastName`,`Phone`,`Mobile`,`Source`,`Email`,`Fax`,`TwitterId`,`StreetAddress`,`City`,`State`,`Country`,`Comment`,`Time`,`Eid`) VALUES 
 ('Sachin','Singh','Gill','256366','9465812356','Adverstisements','sachinsingh@gmail.com','','','Ward No. 3','Bhatinda','Punjab','India','Computer Screen Not Working','2016-11-10 18:06:00','101');
/*!40000 ALTER TABLE `customer` ENABLE KEYS */;


--
-- Definition of table `done`
--
...
CREATE TABLE `done` (
  ...
  KEY `Eid` (`Eid`),
  CONSTRAINT `done_ibfk_1` FOREIGN KEY (`Eid`) REFERENCES `register` (`Eid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `done` (`Eid`,`Emp_name`,`Customer_firstName`,`Customer_middleName`,`Customer_lastName`,`Issue`) VALUES 
 ('101',NULL,'zscmlk','lnlkn','lnlkn',NULL),
 ('101',NULL,'Neetu','dsln','njskdjvbk',NULL),
 ('101',NULL,'Ankit','Kumar','Joshi',NULL),
 ('100',NULL,'Ritik','Kumar','Goyal',NULL),
 ('100',NULL,'wsx','`hmvhv`h','mhvnh',NULL);
...
INSERT INTO `login` (`Eid`,`Password`,`Type`) VALUES 
 ('Aditya','123','admin'),
 ('Kunal','101','employee'),
 ('Vicky','102','employee'),
 ('101','124','employee'),
...
CREATE TABLE `register` (
  ...
  `LeadOwner` varchar(50) default NULL,
...
/*!40000 ALTER TABLE `register` DISABLE KEYS */;
INSERT INTO `register` (`Eid`,`Password`,`Fname`,`Lname`,`Company`,`LeadOwner`,`Phone`,`Email`,`Mobile`,`Website`,`Industry`,`Twitter`,`Skype`,`Street`,`City`,`State`,`Zip`,`Country`) VALUES 
 ('100','100','Prateek','Gupta','HCL','',233652,'prateek@gmail.com','9123656955','www.prateek.com','IT','','','','New Delhi','','110','India'),
 ('101','124','Neeraj','Bansal','HCL','sdjjns',20165,'neeraj@gmail.com','9919818112','www.neeraj.com','HCL','scsc','sdkjbvjb','skdjcbdsjhbhb','jsbvkscv','sbdvksdb','jbjkbkjb','jkbjkbjk');
/*!40000 ALTER TABLE `register` ENABLE KEYS */;


--
-- Definition of table `remark`
--
...
CREATE TABLE `remark` (
  ...
  KEY `Eid` (`Eid`),
  CONSTRAINT `remark_ibfk_1` FOREIGN KEY (`Eid`) REFERENCES `register` (`Eid`),
  CONSTRAINT `remark_ibfk_2` FOREIGN KEY (`Eid`) REFERENCES `register` (`Eid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `remark` (`Eid`,`Customer_firstName`,`Customer_middleName`,`Customer_lastName`,`Mobile`,`Status`,`Comment`) VALUES 
 ('101','zscmlk','lnlkn','lnlkn','654646','Pending','klnkn'),
 ('101','zscmlk','lnlkn','lnlkn','654646','Pending','klnkn'),
 ('101','zscmlk','lnlkn','lnlkn','654646','Pending','klnkn'),
 ('101','Ankit','Kumar','Joshi','6546564654','Pending','c.aksjbalskabwifg ibhjabl sn');
...
DROP TABLE IF EXISTS `v1`;
DROP VIEW IF EXISTS `v1`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v1` AS (select `emp`.`Fname` AS `Fname`,`emp`.`Salary` AS `Salary` from `emp` where (`emp`.`Gender` like _latin1'M'));

--
-- Definition of view `v2`
--

DROP TABLE IF EXISTS `v2`;
DROP VIEW IF EXISTS `v2`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v2` AS (select `emp`.`Fname` AS `Fname`,`emp`.`Salary` AS `Salary` from `emp` where (`emp`.`Gender` like _latin1'F'));

--
-- Definition of view `v3`
--

DROP TABLE IF EXISTS `v3`;
DROP VIEW IF EXISTS `v3`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v3` AS (select `v1`.`Fname` AS `Fname`,`v1`.`Salary` AS `Salary` from `v1`) union (select `v2`.`Fname` AS `Fname`,`v2`.`Salary` AS `Salary` from `v2`);

--
-- Definition of view `v5`
--

DROP TABLE IF EXISTS `v5`;
DROP VIEW IF EXISTS `v5`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v5` AS (select `emp`.`EMP_ID` AS `EMP_ID`,`emp`.`Fname` AS `Fname` from `emp`);

--
-- Definition of view `v6`
--

DROP TABLE IF EXISTS `v6`;
DROP VIEW IF EXISTS `v6`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v6` AS (select `b`.`Fname` AS `Fname`,`b`.`Salary` AS `Salary` from `emp` `b` where (`b`.`Gender` like _latin1'M')) union (select `e`.`Fname` AS `Fname`,`e`.`Salary` AS `Salary` from `emp` `e` where (`e`.`Gender` like _latin1'F'));
